...
enum class TKAResult
{
	...
	f_Distal_MRD,
	/** \brief [ModelOutput]  lateral resection Depth of the distal femur*/
	f_Distal_LRD,
	/** \brief [ModelOutput] medial resection Depth of the posterior femur*/
	f_Posterior_MRD,
	/** \brief [ModelOutput] lateral resection Depth of the posterior femur*/
	f_Posterior_LRD,
