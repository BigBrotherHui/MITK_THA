...
namespace mitk
{
   ...
   * ThinPlateSplineCurvedGeometry
   *   - \b "draw normals 3D": (BoolProperty) If true, a vtkHedgeHog is used to display normals for the generated
   * surface object. Useful to distinguish front and back of a plane. Hedgehogs are colored according to "front color"
   * and "back color"
